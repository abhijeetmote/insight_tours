		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="billpayment">						
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                 <input type="text" id="payment_amount" name="payment_amount" value="<?php echo isset($vendor_amount) ? $vendor_amount : "0.00";?>" placeholder="Enter Amount" class="col-xs-10 col-sm-9 mandatory-field"  onKeyUp="javascript:return check_isammount(event,this);" onblur="sanitize_float(event,this);"/>
                    ...
                    <div class="form-group">
		                    ...
		                    <div class="col-sm-4">
		                        ...
		                        <input type="hidden" id="bill_payment_id" name="bill_payment_id"  class="col-xs-10 form-control col-sm-5 " value="<?php if(isset($bill_payment_id)): echo $bill_payment_id; else: echo 0; endif; ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
...
<script>
            $( document ).ready(function() {    
                //var from_val = <?php echo isset($from_selectd_ledger_id) ? $from_selectd_ledger_id : "0"?>;
                 var from_val = <?php echo isset($vendor_ledger_id) ? $vendor_ledger_id : "0"?>;
