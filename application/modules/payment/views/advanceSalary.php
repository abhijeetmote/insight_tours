		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="advancesalarymaster">						
						 

					<div class="form-group">
                            <label class="col-sm-1 no-padding-right" for="form-field-2"><b class="red"> * </b>For Month</label>
                             <div class="col-sm-3">
	                                <select style="width:250px;" data-placeholder="Salary Month" name="adv_salary_month" id="adv_salary_month" class="chosen-select form-control">
											<?php
												foreach ($months as $key=>$val) 
												{			
											?>								
													<option value="<?php echo $key; ?>" <?php if($key >= date('m')) {if( $key == date('m')): echo "selected"; endif; ?>><?php echo $val; }?></option>
											<?php
												}
											?>
	                                </select>
	                                <span class="help-inline col-xs-12 col-sm-7">
	                                    <span class="middle input-text-error" id="adv_salary_month_errorlabel"></span>
	                                </span>
		                    </div>

                             <label class="col-sm-1 no-padding-right" style="margin-left:85px;" for="form-field-2"><b class="red"> * </b>For Year</label>	
                   			<div class="col-sm-3">
	                                <select style="width:250px;" data-placeholder="Salary Year" name="adv_salary_year" id="adv_salary_year" class="chosen-select form-control">
											<?php
												foreach ($years as $val) 
												{			
											?>								
													<option value="<?php echo $val; ?>" <?php if(  $val == date('Y')): echo "selected"; endif; ?>><?php echo $val; ?></option>
											<?php
												}
											?>
	                                </select>
	                                <span class="help-inline col-xs-12 col-sm-7">
	                                    <span class="middle input-text-error" id="adv_salary_year_errorlabel"></span>
	                                </span>
		                    </div>
                    </div>	 
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <textarea id="narration" name="narration"  placeholder="Enter Narration" class="col-xs-10 col-sm-9 mandatory-field" >Advance salary to Driver</textarea>
                                <span class="help-inline col-xs-12 col-sm-7">
