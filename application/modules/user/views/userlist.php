<div class="main-content">
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<a id="gritter-without-image" class="btn btn-success" class="white" href="<?php echo base_url().'user/user'; ?>">ADD New</a> 
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form" id="userList"></form>
							<div>
									...
									<tbody>
										<?php foreach ($list as $val): ?>
											<tr>
												...
												<td><?php echo $val->user_first_name; ?></td>
												<td><?php echo $val->user_last_name; ?></td>
												<td><?php echo $val->user_email_id; ?></td>
												<td><?php echo $val->user_mobile_number; ?></td>
												<td><?php echo $val->user_source; ?></td>
												 

												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														<input type="hidden" value="<?php if(isset($user)): echo $val->user_id; endif; ?>" name="user_id">

														<a class="green" href="<?php echo base_url().'user/update/'.$val->user_id; ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>

														<a class="red delete" href="#" id="<?php echo $val->user_id; ?>">
