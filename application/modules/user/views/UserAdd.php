			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" id="<?php if(isset($user)): echo "user_update"; else: echo "useradd"; endif; ?>">			
						...
						<div class="form-group">
							<label class="col-sm-2 no-padding-right" for="">User first name*</label>

							<div class="col-sm-9">
								<input type="text" id="first_name" name="first_name" placeholder="Enter First Name" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->user_first_name; endif; ?>" onKeyUp="javascript:return check_isalphanumeric(event,this);" />
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="col-sm-9">
								<input type="text" id="last_name" name="last_name" placeholder="Enter Last Name" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->user_last_name; endif; ?>"  onKeyUp="javascript:return check_isalphanumeric(event,this);"/>
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							<label class="col-sm-2 no-padding-right" for="">User Email id*</label>
						<div class="col-sm-9">
								<input type="text" id="email_id" name="email_id" placeholder="Enter Email id" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->user_email_id; endif; ?>" onblur="check_isemail(this,event);"/>
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							<label class="col-sm-2 no-padding-right" for="form-field-2">User Birth Date*</label>

							<div class="col-sm-9">
								 
								<input type="text" id="user_dob" data-date-format="dd-mm-yyyy" name="user_dob" placeholder="Enter User Birth Date" class="date-picker col-xs-10 col-sm-5 mandatory-field" 
						...
						<div class="col-sm-9">
								<input type="text" id="user_name" name="user_name" placeholder="Enter UserName" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->user_name; endif; ?>" onKeyUp="javascript:return check_isalphanumeric(event,this);" />
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="col-sm-9">
								<input type="password" id="password" name="password" placeholder="Enter Password" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->password; endif; ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							<label class="col-sm-2 no-padding-right" for="">Retype Password*</label>
						<div class="col-sm-9">
								<input type="password" id="re_password" name="re_password" placeholder="Retype Password" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->password; endif; ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="mob_no" name="mob_no" placeholder="Enter Mobile Number" class="col-xs-10 col-sm-5 mandatory-field" value="<?php if(isset($user)): echo $user[0]->user_mobile_number; endif; ?>" onChange="javascript:return check_ismobile(event,this);" />
								<span class="help-inline col-xs-12 col-sm-7">
