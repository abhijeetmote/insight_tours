	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Customer Lists</li>
			</ul><!-- /.breadcrumb -->
		...
		<div class="page-content">
			...
			<a id="gritter-without-image" class="btn btn-success" class="white" href="<?php echo base_url().'customer/customerMaster'; ?>">ADD New</a> 
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form" id="customerList"></form>
							<div>
											...
											<tr>
												...
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														...
														<a class="red delete" href="#" id="<?php echo $val->cust_id; ?>">
