        ...
        //print_r($translist);
                      ?>
                            <tr  >
                                ...
                                ?></td>
                                <td>
                                <?php if(($translist['is_opening_balance']!='') && ($translist['is_opening_balance']==1 || $translist['is_opening_balance']==0)) {  ?>
                                <a href="<?php echo $config->system->full_base_url . "transaction/editTransaction/" . $translist['txn_id']; ?>" title="Edit"><i class="fa fa-edit"></i></a>|
                                <a href="<?php echo $config->system->full_base_url . "transaction/delete/" . $translist['txn_id']; ?>" title="Delete"  onclick="javascript:if(confirm('Do you want to discard this transaction?') ) {return true;}else {var obj = this;$(this).css({display:'inline-block',color:'#000'});return false;}" ><i class="fa fa-trash"></i></a>
                                <?php } ?>
                                </td>
                             </tr>  
                      <?php }  ?>
